...
// ⚠️ PERSONALIZA ESTO: Nombre único para tu app
const CACHE_NAME = 'mi-app-v1.0';

const BASE = self.location.pathname.replace(/sw\.js$/, '');

// ⚠️ PERSONALIZA ESTO: Agrega aquí todos los archivos de tu app
const PRECACHE = [
  BASE,
  BASE + 'index.html',
  BASE + 'auth.js',
  ...
  BASE + 'fenix.html',
  BASE + 'manifest.json',
  // ← Agrega aquí tus recursos (CSS, JS, imágenes, fuentes, etc.)
  // Ejemplo:
  // BASE + 'styles.css',
  // BASE + 'app.js',
...
self.addEventListener('fetch', event => {
  ...
  // No intercepta otros dominios (puedes agregar excepciones como imgur)
  if (!isLocal) return;
          ...
          return new Response(
            ...
            <head>
              ...
              <style>
                ...
                button { margin-top: 24px; padding: 12px 28px; background: #667eea;
